      ...
      <div className="solarProjectWrapper">
        <div className="solarProject">
          ...
          <div className="text11">
            <span className="text3" onClick={() => navigate("/solarproject")}>
              All
            </span>
            <span
              className="text2"
            ...
            <span className="text1">Off-grid & Hybrid</span>
          </div>
...
export default OffgridSolarProject;
