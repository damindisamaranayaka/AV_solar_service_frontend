...
const Admins = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        const admins = response.data.filter((user) => user.user_type_id === 1);
        setUsers(admins);
      })
    ...
    <Layout>
      <div className="usersContainer">
        ...
        <div className="userTypeTabs">
          ...
          <span className="tab1">Admin</span>
          <span className="tab" onClick={() => navigate("/super-admins")}>
            Super Admin
          </span>
          <span className="tab" onClick={() => navigate("/customers")}>
            Customers
          </span>
